...
suspend fun Service.createBettboxNotificationBuilder(): NotificationCompat.Builder =
    withContext(Dispatchers.IO) {
        val defaultComponent = ComponentName(packageName, "com.speedcat.client.MainActivity")
        val lightComponent = ComponentName(packageName, "com.speedcat.client.MainActivityLight")
