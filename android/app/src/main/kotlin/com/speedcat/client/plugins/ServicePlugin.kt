    ...
    override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
        when (call.method) {
            ...
            "updateNotificationSpeed" -> {
                ...
                com.speedcat.client.GlobalState.currentProfileName = profileName
                com.speedcat.client.GlobalState.isSpeedNotificationEnabled = true
                val context = com.speedcat.client.BettboxApplication.getAppContext()
                context?.let {
                    android.service.quicksettings.TileService.requestListeningState(
                        it,
                        android.content.ComponentName(it, com.speedcat.client.services.BettboxTileService::class.java)
                    )
                }
            ...
            "restoreNotification" -> {
                val context = com.speedcat.client.BettboxApplication.getAppContext()
                if (context != null) {
                    com.speedcat.client.GlobalState.isSpeedNotificationEnabled = false
                    android.service.quicksettings.TileService.requestListeningState(
                        context,
                        android.content.ComponentName(context, com.speedcat.client.services.BettboxTileService::class.java)
                    )

                    val intent = android.content.Intent(
                        context, 
                        com.speedcat.client.services.BettboxVpnService::class.java
                    ).apply {
